...
import { ResponseDto, SignInResponseDto } from 'apis/response';
  ...
  const SignUpCard = () => {
    ...
    const onNextButtonClickHandler = () =>{
      ...
      if(!isEqualPassword){
        ...
        setPasswordCheckError(true);
        setPasswordCheckErrorMessage('비밀번호 확인란이 비어있습니다.');
    ...
    // event handler : 개인 정보 동의 체크 버튼 클릭 이벤트 처리
          ...
          <div className='auth-card-top'>
            ...
            {page === 2 && (
              <>
                ...
                <InputBox ref={addressDetailRef} label='상세 주소' type='text' placeholder='상세 주소를 입력해주세요.' value={addressDetail} onChange={onAddressDetailChangeHandler} error={false} message='' onKeyDown={onAddressDetailKeyDownhandler} />
              </>
            )}
          </div>
          <div className='auth-card-bottom'>
            {page === 1 && (
              <div ref={nextButtonRef} className='black-large-full-button' onClick={onNextButtonClickHandler}>{'다음 단계'}</div>
            )}
            {page === 2 && (
              <>
        ...
        <div className='auth-jumbotron-box'>
          <div className='auth-jumbotron-contents'>
            ...
            <div className='auth-jumbotron-text-box'>
              ...
              <div className='auth-jumbotron-text'>{'JANG GEOL\'S BOARD입니다.'}</div>
            </div>
          </div>
        </div>
