...
const usePagination = <T>(countPerPage: number) => {
    ...
    const setView = () => {
        ...
        const LAST_INDEX = totalList.length > countPerPage * currentPage ? countPerPage * currentPage : totalList.length;// slice() 적힌 마지막 인덱스를 자르기 때문에 -1 생략
